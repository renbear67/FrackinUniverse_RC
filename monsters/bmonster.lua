...
function rotate(args, output)
  ...
  while true do
    ...
    world.debugLine(mcontroller.position(), vec2.add(mcontroller.position(), vec2.mul(vec2.rotate({1,0}, entity.currentRotationAngle("all") - entity.configParameter("rotationOffset", 0)), 10)), "green")
