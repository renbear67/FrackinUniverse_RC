...
{inputs = { laboil=1 }, outputs = { liquidoil=40 }, time = 1},
...
-- tiles
{inputs = { biorock=50 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { biorock2=50 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { frozendirt=50 }, outputs = { nutrientpaste=5 }, time = 1},
...
{inputs = { bloodstonewall=50 }, outputs = { quietusore=2 }, time = 1},
...
{inputs = { glowsandmaterial=50 }, outputs = { rawminerals=8 }, time = 1},
...
{inputs = { bloodrootseed=1 }, outputs = { liquidblood=5 }, time = 1},
...
{inputs = { corvexseed=1 }, outputs = { corvex=2 }, time = 1},
...
{inputs = { wildcorvexseed=1 }, outputs = { corvex=2 }, time = 1},
...
{inputs = { aenemaflower=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { arkaentree=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { batterystem=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { bellamorte=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { bladetree=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { crystallite=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { darklightflower=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { fletchweed=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { garikleaf=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { herrodbush=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { kramil=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { poetree=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { quellstem=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { tinselbush=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { victorleaf=1 }, outputs = { geneticmaterial=5 }, time = 1},
{inputs = { whitespine=1 }, outputs = { geneticmaterial=5 }, time = 1},
...
{inputs = { arkaendart=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { batterystemcharge=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { bellamortecore=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { bladetreeblade=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { crystalliteshard=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { darklightblossom=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { fletchweedstem=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { garikleafblossom=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { herrodbushgem=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { kramilspine=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { quellstembud=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { tinselbushsprout=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { victorleafbud=1 }, outputs = { tissueculture=8 }, time = 1},
{inputs = { whitespineshell=1 }, outputs = { tissueculture=8 }, time = 1},
