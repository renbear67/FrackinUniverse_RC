...
{inputs = { glowfibreblue=20 }, outputs = { luminescentpaste=7 }, time = 1},
{inputs = { glowfibregreen=20 }, outputs = { luminescentpaste=7 }, time = 1},
{inputs = { glowfibreorange=20 }, outputs = { luminescentpaste=7 }, time = 1},
{inputs = { glowfibreyellow=20 }, outputs = { luminescentpaste=7 }, time = 1},
...
{inputs = { bloodstonewall=50 }, outputs = { blooddiamond=2 }, time = 1},
{inputs = { bloodstonewall2=50 }, outputs = { rawminerals=4 }, time = 1},
{inputs = { bloodstonewall3=50 }, outputs = { phosphorus=2 }, time = 1},
