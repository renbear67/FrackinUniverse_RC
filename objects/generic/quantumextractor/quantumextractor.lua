...
{inputs = { iceblockmaterial=50 }, outputs = { rawminerals=2 }, time = 1},
{inputs = { iceblock2material=50 }, outputs = { rawminerals=4 }, time = 1},
{inputs = { iceblock3material=50 }, outputs = { rawminerals=4 }, time = 1},
{inputs = { iceblock4material=50 }, outputs = { rawminerals=4 }, time = 1},
