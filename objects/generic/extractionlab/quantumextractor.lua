...
{
---- resources
{inputs = { energywood=12 }, outputs = { penumbriteore=2 }, time = 1},
{inputs = { alienweirdwood=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { alienwoodsap=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { ancientbones=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { artificialbrain=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { basicpelt=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { biosample=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { bolt=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { bone=1 }, outputs = { liquidoil=2 }, time = 1},
{inputs = { bottle=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { brain=1 }, outputs = { tissueculture=9 }, time = 1},
{inputs = { bugshell=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { cellmateria=1 }, outputs = { geneticmaterial=2 }, time = 1},
{inputs = { cellmatter=1 }, outputs = { geneticmaterial=2 }, time = 1},
{inputs = { coralfragment=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { dragonbone=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { endomorphicjelly=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { fabric=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { fossilore=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { fleshstrand=10 }, outputs = { geneticmaterial=2 }, time = 1},
{inputs = { giantflowerpetal=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { glowfibreblue=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { glowfibregreen=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { glowfibreorange=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { glowfibreyellow=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { gnome=1 }, outputs = { bone=2 }, time = 1},
{inputs = { greenslime=1 }, outputs = { tissueculture=2 }, time = 1},
{inputs = { gunpowder=1 }, outputs = { saltpeter=2 }, time = 1},
{inputs = { inferiorbrain=1 }, outputs = { tissueculture=2 }, time = 1},
...
{inputs = { peralblue=1 }, outputs = { tissueculture=2 }, time = 1},
...
{inputs = { ff_silicon=1 }, outputs = { glassmaterial=4 }, time = 1},
...
{inputs = { cellpods=1 }, outputs = { geneticmaterial=2 }, time = 1},
