...
{inputs = { boltbulbseed=1 }, outputs = { gene_energy=1 }, time = 1.2},
...
{inputs = { ignuschiliseed=1 }, outputs = { gene_pyro=2 }, time = 1.2},
{inputs = { ignuschili2seed=1 }, outputs = { gene_pyro=3 }, time = 1.2},
...
{inputs = { wildhopsseed=1 }, outputs = { gene_stimulant=1 }, time = 1.2},
...
{inputs = { wildboltbulbseed=1 }, outputs = { gene_energy=1 }, time = 1.2},
