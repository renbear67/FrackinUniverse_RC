...
{inputs = { boltbulbseed=1 }, outputs = { gene_energy=1 }, time = 5.5},
...
{inputs = { wartweedseed=1 }, outputs = { gene_poisonous=1 }, time = 5.5},
...
{inputs = { fusnowberryseed=1 }, outputs = { gene_immunity=1 }, time = 5},
...
{inputs = { livingrootseed=1 }, outputs = { gene_defense=1 }, time = 5.5},
...
{inputs = { ignuschiliseed=1 }, outputs = { gene_pyro=2 }, time = 5.5},
{inputs = { ignuschili2seed=1 }, outputs = { gene_pyro=3 }, time = 5.5},
...
{inputs = { mireurchinseed=1 }, outputs = { gene_agilty=1 }, time = 5.5},
...
{inputs = { wildboltbulbseed=1 }, outputs = { gene_energy=1 }, time = 5.5},
...
{inputs = { wildwartweedseed=1 }, outputs = { gene_poisonous=1 }, time = 5.5},
...
{inputs = { wildfusnowberryseed=1 }, outputs = { gene_immunity=1 }, time = 5},
...
{inputs = { wildlivingrootseed=1 }, outputs = { gene_defense=1 }, time = 5.5},
...
{inputs = { wildmireurchinseed=1 }, outputs = { gene_agilty=1 }, time = 5.5},
...
{inputs = { glowfibre=4 }, outputs = { gene_bioluminescent=1 }, time = 5.5},
{inputs = { plantfibre=4 }, outputs = { gene_reproductive=2 }, time = 5.5}
}
